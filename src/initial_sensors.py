...
sensors["Axel"] = sn.Sensor(fp=fp.EggFootprint(best_distance=0.5))
sensors["Bo"] = sn.Sensor(fp=fp.EggFootprint(best_distance=1.0))
sensors["Calle"] = sn.Sensor(fp=fp.OmnidirectionalFootprint(gain=0.5))
sensors["David"] = sn.Sensor(fp=fp.OmnidirectionalFootprint(gain=0.5))
